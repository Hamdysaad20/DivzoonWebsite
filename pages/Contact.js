        ...
        overflow: "hidden",
            ...
            <div className=' md:grid md:grid-cols-2 w-full  rounded-md bg-gray-700/20 max-h-[320px] align-middle text-center items-center  '>
              <div className='relative pt-3 '>
                ...
                <Link  passHref href='https://www.linkedin.com/company/divzoon'  >
                 <div><h1 className='hover:underline active:scale-95   select-none ml-2 hidden md:block lg:text-xl  text-gray-500' style={{ fontFamily: "Poppins-Bold" }}>Follow us on LinkedIn</h1></div>                 
                </Link>
              </div>
            ...
            <div className=' w-full px-2 pt-2 '>
              <div className='relative   rounded-md bg-red-500/20 '>
                <h1
                  ...
                  <Link  passHref  href='mailto:support@divzoon.com'  >
                   <div><h1
                      key='coloredText4'
