...
قم بترقية موقع الويب او تطبيقك الحالي الخاص بك واجعله مناسباً لمعايير التصميم في {currentYear}
          ...
          <div className='relative flex flex-col justify-center md:flex-row md:space-x-4'>
            <Link href='/ar/Contact'
                ...
                className='flex items-center w-full px-6 py-1 pt-2 mb-1 text-lg text-white bg-red-700 rounded-md md:mb-0 hover:bg-red-900 md:w-auto'>
                
           <div className="flex gap-2">  <h3>  ابدأ الآن</h3>
