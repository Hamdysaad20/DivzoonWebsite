...
function Header(props) {
  ...
  return (
    <div style={{ fontFamily: "SfproText", width: "600" }}
      className={
        navbarVisibility
          ? "   active z-50  justify-center bglolh fixed backdrop-blur-xl   w-full "
      ...
      <div className='px-4  grid grid-cols-3 py-3 max-w-[1400px] mx-auto  w-full    h-[70px]'>
        ...
        <div className='lg:flex pt-3 hidden text-stone-100 select-none cursor-pointer  gap-4 justify-center mx-8'>
          <Link href={props.HerfService} passHref>
            <h4 className='duration-500 hover:text-gray-500'>خدماتنا</h4>
          </Link>

          <Link href={props.HerfContact} passHref>
            <h4 className='duration-500 hover:text-gray-500'>تواصل معنا</h4>
          </Link>
        </div>
          ...
          <div className='relative'>
            <div className=' '>
              <div className='lg:flex  gap-3 hidden '>
                ...
                <Tooltip  content={" ...  ستتوفر قريبا"}  className=" hidden"         placement="bottom" rounded color="invert">
                <button  className=' hover:text-white text-gray-900  box-decoration-slice shadow-md hover:shadow-red-500/40    focus:outline-none focus:ring-1 focus:ring-slate-400 focus:ring-offset-2 active:scale-95 duration-300 focus:ring-offset-slate-800  font-bold h-9 px-6 rounded-lg w-full flex items-center justify-center sm:w-auto bg-gray-200  hover:bg-red-400'>
                <h5 style={{ fontFamily: "SfproText", width: "600" }}   className='hidden blocksoon mt-2 px-1 rounded-lg duration-200   bg-red-400'>🙃قريبا  </h5>
                  <Link href={props.HerfDash} passHref>
                    <h5 style={{ fontFamily: "SfproText", width: "600" }} className='ml-2 m-auto font-bold text-gray-900 hover:text-gray-900'>لوحة التحكم</h5>
                  </Link>
                </button>
                </Tooltip>
                ...
                <div className=' mt-4 hidden lg:inline-block justify-start bg-gray-800/40 w-24 rounded-sm  py-1 h-18'>
                  ...
                  <Link href={props.enUrl} passHref>
                    <div className='flex justify-around px-2 pt-1 opacity-60 hover:opacity-100 select-none duration-500 cursor:pointer align-middle  gap-1 bg-gray-700 mx-1  rounded-sm'>
                      ...
                      <h6 style={{ fontFamily: "Poppins-Bold", width: "400" }}>English</h6>
                    </div>
                  </Link>
                </div>
              ) : null}
      ...
      <div
        ...
        <div className=' select-none mx-12 cursor-pointer  m-3 text-center lg:hidden'>
          <Link className='text-gray-300' href={props.HerfDash} passHref>
            ...
            <h5   className=' px-1 rounded-lg duration-200   bg-red-400'>🙃قريبا  </h5>
