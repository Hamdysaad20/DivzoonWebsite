...
function TeamMembersHome() {
  ...
  const employees =[
    ...
    <div className='mt-3 space-y-2 text-center'>
      <div className='space-y-1 text-lg font-medium leading-6'>
        <h3>Esraa Afifi</h3>
        <p className='text-gray-500 font-medium'>Flutter Developer</p>
      </div>
    </div>
  </div>),
  ( <div key="s7" className='flex flex-col items-center justify-center col-span-1'>
  <div className='hover:scale-105  duration-300  relative '>
    <div className='absolute z-10 border-0 hover:scale-105 sm:hover:scale-110 duration-300 w-full h-full -mt-5 -ml-5 rounded-full rounded-tr-none bg-gray-800' />
    <Image
      className='relative z-20 w-full rounded-full'
      height='200'
      width='200'
    ...
    (
      <div  key="s1" className='flex flex-col items-center justify-center col-span-1'>
        ...
        <div className='mt-3 space-y-2 text-center'>
          <div className='space-y-1 text-lg font-medium leading-6'>
            <h3>Hamdy Saad</h3>
            <p className=' subpixel-antialiased text-gray-500  font-medium'>
      ...
      (
        ...
        <div className='mt-3 space-y-2 text-center'>
          <div className='space-y-1 text-lg font-medium leading-6'>
            ...
            <p className='text-gray-500 font-medium'>Android Developer</p>
          </div>
        </div>
      </div>
      ),
      ...
      (
        <div  key="s11" className='flex flex-col items-center justify-center col-span-1'>
              <div className='hover:scale-105 duration-500  relative '>
              ...
              <div className='mt-3 space-y-2 text-center'>
                <div className='space-y-1 text-lg font-medium leading-6'>
                  ...
                  <p className='text-gray-500 font-medium'>Senior Application Engineer</p>
                </div>
              </div>
            </div>
        ...
        <div  key="s6" className=' flex flex-col items-center justify-center col-span-1'>
              ...
              <div className='mt-3 space-y-2 text-center'>
                <div className='space-y-1 text-lg font-medium leading-6'>
                  ...
                  <p className='text-gray-500 font-medium'>Sales Manager</p>
                </div>
              </div>
            </div>
      ),
  ...
  return (
    <div
      ...
      <section className='relative pt-20 overflow-hidden  text-gray-200'>
        ...
        <div className=' relative sm:px-16 px-8 mx-auto max-w-7xl'>
          <p className='select-none font-medium tracking-wide text-red-500 uppercase'>
            OUR TEAM
          </p>
          <h2
    style={{ fontFamily: "Poppins, sans-serif" }}
          ...
          Discover Them <br/>With Every <span className="header"> Click</span>
</span>
      ...
      <svg  className="mt-3 spinner spinnerHW" fill="#f56565" hight="40px" width="40px"  version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 489.533 489.533" style={{enableBackground: 'new 0 0 489.533 489.533'}} xmlSpace="preserve">
        ...
        <g>
          ...
          <div style={{ fontFamily: "Poppins-Bold", width: "400" }} className='grid w-full grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-4'>
                {empState.slice(0,7)}
            <Link href='/Career' passHref>
              <div className=' cursor-pointer flex flex-col items-center justify-center col-span-1'>
                ...
                <div className='mt-3 space-y-2 text-center'>
                  <div className='space-y-1 text-lg font-medium leading-6'>
                    <h3 className='text-red-400'>Join US</h3>
                  </div>
                </div>
              </div>
            </Link>
